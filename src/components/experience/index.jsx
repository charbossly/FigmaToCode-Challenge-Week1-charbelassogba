...
import squellete from "../../assets/images/squellete.png";
function index(props) {
  return (
    <section className=" bg-secondWhiteUi">
      <div
        data-aos="flip-down"
        className="max-w-screen-lg mx-auto gap-2 lg:gap-8 flex flex-col lg:flex-row justify-between  p-12 px-4 lg:px-24 items-center"
      >
        <div className="w-full lg:w-1/2 order-2 lg:order-1">
          <h5 className="text-greenUi my-3 text-[22px]">Services</h5>
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2">
          <img className="h-96" src={squellete} alt="" />
        </div>
      </div>
    </section>
  );
